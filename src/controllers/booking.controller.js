...
//         if (staff_id) {
//             // Jika user pilih staff tertentu
...
//             // Tidak perlu gagalkan booking jika notifikasi gagal
//         }
...
//         res.status(200).json({ message: 'Status booking berhasil diperbarui', booking });
//     } catch (error) {
